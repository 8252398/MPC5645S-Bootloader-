...
#pragma push
#pragma section ".reset_Interface" 
__declspec(section ".reset_Interface")
asm void __reset_start(register int argc, register char **argv, register char **envp)
{
...
asm void __init_user(void)
{
	...
	lis      r6,Bootloader_main@ha
	addi     r6,r6,Bootloader_main@l
	mtlr     r6
	mr		 r3, r14
	mr		 r4, r15
	mr		 r5, r16
